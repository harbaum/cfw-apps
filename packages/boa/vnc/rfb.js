...
/* [module] export default */ function RFB(defaults) {
    ...
    Util.set_defaults(this, defaults, {
        ...
        'mouse_only': false,                    // Disable client keyboard
...
(function() {
    ...
    RFB.prototype = {
        ...
        sendCtrlAltDel: function () {
            if (this._rfb_connection_state !== 'connected' || this._view_only || this._mouse_only) { return false; }
        ...
        _cleanup: function () {
            if (!this._view_only && !this._mouse_only) { this._keyboard.ungrab(); }
        ...
        _handleKeyPress: function (keyevent) {
            if (this._view_only || this._mouse_only) { return; } // View only, skip keyboard, events
        ...
        _negotiate_server_init: function () {
            ...
            if (!this._view_only && !this._mouse_only) { this._keyboard.grab(); }
    ...
    Util.make_properties(RFB, [
        ...
        ['mouse_only', 'rw', 'bool'],           // Disable client keyboard
